      ...
      <section className='relative bg-cream pt-10 lg:pt-20'>
        ...
        <div className='relative spacing container mx-auto flex flex-col justify-center items-center z-10'>
          <motion.h1
            ...
            className={`text-3xl md:text-4xl xl:text-5xl font-bold text-black text-center mb-4 ${regalDisplay.className}`}>
            {product.name}
          </motion.h1>
          <motion.h6
            initial={{ opacity: 0, y: 50 }}
            ...
            className={`${josefinSemiBold.className} text-xl lg:text-2xl text-black mb-4`}>
          ...
          <motion.p
            ...
            className={`text-base md:text-lg text-black leading-normal max-w-full lg:max-w-[60ch] mx-auto text-center mb-4 ${poppinsRegular.className}`}>
